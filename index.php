...
<body>
    <div class="container-fluid p-0">
        ...
        <div class="row g-0 align-items-center mb-9">
            <div class="col-5 p-0">
                <img src="images/Reese_Photo_2.JPG" alt="reese_pic" class="animated-element fade-in-up img-fluid equal-img">
            </div>

            <div class="col-7 p-0">
                <img src="images/Reese_Photo_1_cropped.JPG" alt="reese_pic_2" class="animated-element fade-in-up img-fluid equal-img">
        ...
        <div class="row g-0 my-5 align-items-center mb-9">
            ...
            <div class="col-4 animated-element fade-in-right">
                <img src="images/Reese_Leevi_Pic.JPG" alt="reese_pic_2" class="animated-element img-fluid paragraph-img">
            </div>

            <div class="col-3 animated-element fade-in-right">
                <img src="images/Reese_Leevi_Pic_2.JPG" alt="" class="img-fluid paragraph-img">
            </div>
        </div>
        ...
        <div class="row g-0 text-center mb-9 align-items-center">
            <div class="col-4">
                <h1 class="story-heading p-0 animated-element fade-in-left">Follow Reese</h1>
                <p class="lead text-center ps-4 pe-4 animated-element fade-in-left">
            ...
            <div class="col-4">
                <img src="images/Reese_Food_Pic.JPG" alt="Reese_300_Main" class="paragraph-img animated-element fade-in-up">
            </div>
            <div class="col-4">
                <img src="images/Reese_Outside_Pic.jpeg" alt="" class="paragraph-img animated-element fade-in-right">
            </div>
        </div>
    </div>

    <div class="row g-0 mb-9 text-center align-items-center">
        <div class="col text-center animated-element fade-in-left">
                <img src="images/Reese_Hockey_Guys.JPG" alt="Reese_Hockey_Guys" class="img-fluid contact-img">
            </div>

            <div class="col animated-element fade-in-left">
                <img src="images/Reese_Hockey_Guys_2.JPG" alt="Reese_Hockey_Guys_2" class="img-fluid contact-img">
            </div>

            <div class="col">
            <h1 class="story-heading p-0 animated-element fade-in-right">NoBad Collaboration</h1>
            <p class="lead text-center animated-element fade-in-right ps-4 pe-4">Reese has teamed up with NoBad Apparel for an exciting collaboration that blends iconic chocolatey goodness with streetwear style.
